...
r = requests.get('https://{team_domain}.cupix.works/api/v1/pointclouds', params={
...
r = requests.get('https://{team_domain}.cupix.works/api/v1/pointclouds', params={
  'fields': 'id,name,state,record,level,parent,kind,meta,pointcloud_type',
...
r = requests.get('https://{team_domain}.cupix.works/api/v1/pointclouds/{id}', params={
  'fields': 'id,name,state,record,level,parent,kind,meta,pointcloud_type, mesh_uploaded_at, ply_uploaded_at'
}, headers = headers)
...
r = requests.get('https://{team_domain}.cupix.works/api/v1/pointclouds/{id}/meta', params={
